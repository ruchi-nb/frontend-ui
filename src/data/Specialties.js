...
export const specialties = {
  Cardiology: {
    ...
    doctors: [
      { name: "Dr. Emily Chen", role: "Senior Cardiologist", experience: "12 years", active: true, img: "/images/woman(3).png" },
      { name: "Dr. Tsunade Senju", role: "Cardiac Surgeon", experience: "30 years", active: true, img: "/images/woman(5).png" }
    ],
  ...
  Dermatology: {
    ...
    doctors: [
      { name: "Dr. Michael Rodriguez", role: "Senior Dermatologist", experience: "15 years", active: true, img: "/images/man(2).png" }
    ],
  ...
  "General Medicine": {
    ...
    doctors: [
      { name: "Dr. James Wilson", role: "General Physician", experience: "8 years", active: true, img: "/images/man(1).png" },
      { name: "Dr. Tony Chopper", role: "General Practitioner", experience: "7 years", active: true, img: "/images/man(5).png" },
      { name: "Dr. Kureha", role: "Senior General Physician", experience: "50+ years", active: true, img: "/images/woman(4).png" }
    ],
  ...
  Pediatrics: {
    ...
    doctors: [
      { name: "Dr. Sarah Johnson", role: "Pediatrician", experience: "10 years", active: true, img: "/images/woman(1).png" },
      { name: "Dr. Hiluluk", role: "Community Pediatrician", experience: "20 years", active: true, img: "/images/man(6).png" }
    ],
  ...
  Orthopedics: {
    ...
    doctors: [
      { name: "Dr. Tarun Singh", role: "Orthopedic Surgeon", experience: "18 years", active: true, img: "/images/man(3).png" }
    ],
  ...
  Neurology: {
    ...
    doctors: [
      { name: "Dr. Devangi Patel", role: "Neurologist", experience: "14 years", active: true, img: "/images/woman.png" },
      { name: "Dr. Senku Ishigami", role: "Neurology Researcher", experience: "10 years", active: true, img: "/images/man(8).png" }
    ],
  ...
  Oncology: {
    ...
    doctors: [
      { name: "Dr. Kshitij Mehta", role: "Oncologist", experience: "16 years", active: true, img: "/images/man(4).png" }
    ],
  ...
  Psychiatry: {
    ...
    doctors: [
      { name: "Dr. Veena Gupta", role: "Psychiatrist", experience: "13 years", active: true, img: "/images/woman(2).png" },
      { name: "Dr. Franken Stein", role: "Psychiatric Specialist", experience: "18 years", active: true, img: "/images/man(7).png" }
    ],
